...
// first add the tileset to texture manager
	TheTextureManager::Instance()->load(pTilesetRoot
										...
										->Attribute("source"),
										pTilesetRoot
										->Attribute("name"),// maybe a problem.. the name generated by tiled isn'et the same
										TheGame::Instance()
										->getRenderer());
// create a tileset object
	...
	std::cout << pTilesetRoot->Attribute("name") << std::endl;
}
